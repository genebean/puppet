...
group(:features) do
  ...
  gem 'opentelemetry-exporter-jaeger', '= 0.8.0', require: false
  gem 'opentelemetry-instrumentation-net_http', '= 0.8.0', require: false
  gem 'opentelemetry-propagator-b3', '= 0.8.0', require: false
  gem 'opentelemetry-resource_detectors', '= 0.8.0', require: false
  gem 'opentelemetry-sdk', '=0.8.0', require: false
